...
contract('Remittance', accounts => {
    ...
    it("should update password hash", async () => {
        await instance.deposit(hash1, 100, accounts[1], { from: accounts[0], value: 1000 });
    ...
    it("should not update password hash if the new hash is already used", async () => {
        await instance.deposit(hash1, 100, accounts[1], { from: accounts[0], value: 1000 });
        await instance.deposit(hash2, 100, accounts[1], { from: accounts[0], value: 1000 });
    ...
    it("should deposit new founds", async () => {
        let depositTx = await instance.deposit(hash1, 100, accounts[1], { from: accounts[0], value: 1000 });
    ...
    it("should not deposit if paused", async () => {
        ...
        await expectedExceptionPromise(() =>
            instance.deposit(hash1, 100, accounts[1], { from: accounts[0], value: 1000, gas: 3000000 }), 3000000);
    });
    
    it("should not deposit if duration is over max limit", async () => {
        await expectedExceptionPromise(() =>
            instance.deposit(hash1, 5184000 /*60 days*/, accounts[1], { from: accounts[0], value: 1000, gas: 3000000 }), 3000000)
    });
    
    it("should not deposit if already deposited", async () => {
        await instance.deposit(hash1, 100, accounts[1], { from: accounts[0], value: 1000 });
        await expectedExceptionPromise(() =>
            instance.deposit(hash1, 100, accounts[1], { from: accounts[0], value: 2000, gas: 3000000 }), 3000000);
    });
    ...
    it("should not withdraw with passwords if expired", async () => {
        await instance.deposit(hash1, 1, accounts[1], { from: accounts[0], value: 1000 });
        wait(2000);

        await expectedExceptionPromise(() =>
            instance.withdrawDeposit(accounts[0], "te", "st", { from: accounts[1], gas: 3000000 }), 3000000);
    });
